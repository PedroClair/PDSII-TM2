...
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/conta.o ${BUILD_DIR}/cliente.o ${BUILD_DIR}/circunferencia.o ${BUILD_DIR}/pontoV2.o ${BUILD_DIR}/classeTeste.o ${BUILD_DIR}/mathUtil.o ${BUILD_DIR}/estatico.o ${BUILD_DIR}/testObject.o ${BUILD_DIR}/ponto.o ${BUILD_DIR}/casa.o ${BUILD_DIR}/aluno.o ${BUILD_DIR}/compra.o ${BUILD_DIR}/funcionario.o ${BUILD_DIR}/intro.o ${BUILD_DIR}/memory.o  ${BUILD_DIR}/ponteiro.o ${BUILD_DIR}/ponto3d.o ${BUILD_DIR}/main.o
	${CC} ${CFLAGS} -o ${BUILD_DIR}/${TARGET} ${BUILD_DIR}/*.o

${BUILD_DIR}/conta.o:  ${INCLUDE_DIR}/pooEncapsulamento/conta.hpp ${SRC_DIR}/pooEncapsulamento/conta.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR}/pooEncapsulamento/ -c ${SRC_DIR}/pooEncapsulamento/conta.cpp -o  ${BUILD_DIR}/conta.o
