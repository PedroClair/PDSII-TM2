...
void ponteiroParaVoid(){
    ...
    int_ptr = &i;
    void_ptr = int_ptr; // OK
    //double_ptr = int_ptr; // !OK a value of type "int *" cannot be assigned to an entity of type "double *" C/C++(513)
    //double_ptr = void_ptr; // !OK a value of type "void *" cannot be assigned to an entity of type "double *"C/C++(513)
